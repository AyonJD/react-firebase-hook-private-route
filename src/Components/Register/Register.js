...
const Register = () => {
    const { email, password, confirmPassword, getEmail, getConfirmPassword, getPassword } = useInput();
    const [
    ...
    return (
        <div className='w-1/3 mx-auto mt-8 bg-white p-10 bg-opacity-10 bgc-blur bg-clip-padding rounded-lg'>
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <div className="relative z-0 mb-6 w-full group">
                   <p className='text-white'>Already have an account? <span className='underline ml-5'><Link to="/login">Login Here</Link></span></p>
                </div>
